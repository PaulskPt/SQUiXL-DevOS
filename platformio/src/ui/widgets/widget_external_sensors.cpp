#include "ui/widgets/widget_external_sensors.h"
#include "external_sensors/external_sensors.h"
#include "ui/ui_screen.h"

using json = nlohmann::json;

bool widgetEXTSS::redraw(uint8_t fade_amount, int8_t tab_group)
{
	if (widget_extss.dirty)
	{
		should_redraw = true;
		extss_stuff.set_dirty(false);
	}
	...
	if (is_dirty || fade_amount == 0)
	{
		...
		for (auto &sensor_data : extss_stuff.extss_topic_payloads)
		{
...
bool widgetEXTSS::process_touch(touch_event_t touch_event)
{
